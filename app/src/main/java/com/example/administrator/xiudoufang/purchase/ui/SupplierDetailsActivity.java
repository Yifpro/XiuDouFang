    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_sure:
                ...
                details.setCustomername(mBean.getCustomername());
                details.setQuancheng(mBean.getQuancheng());
                details.setDebt(mBean.getDebt());
                details.setTelephone(TextUtils.isEmpty(mSivNewMobilePhoneNum.getValue()) ? TextUtils.isEmpty(mBean.getTelephone()) ? "" : mBean.getTelephone() : mSivNewMobilePhoneNum.getValue());
                details.setDianhua(mSivNewPhoneNum.getValue());
                details.setLianxiren(mSivNewContact.getValue());
                details.setQuyuno(mSivAreaNo.getValue());
                details.setQuyu(mSivAreaName.getValue());

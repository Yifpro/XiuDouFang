...
public final class ScreenUtils {
    ...
    public static int getScreenWidth() {
        WindowManager wm = (WindowManager) XiuDouFangApplication.getContext().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return XiuDouFangApplication.getContext().getResources().getDisplayMetrics().widthPixels;
        }
    ...
    public static int getScreenHeight() {
        WindowManager wm = (WindowManager) XiuDouFangApplication.getContext().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return XiuDouFangApplication.getContext().getResources().getDisplayMetrics().heightPixels;
        }
        Point point = new Point();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            wm.getDefaultDisplay().getRealSize(point);
    ...
    public static float getScreenDensity() {
        return XiuDouFangApplication.getContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static int getScreenDensityDpi() {
        return XiuDouFangApplication.getContext().getResources().getDisplayMetrics().densityDpi;
    }
    ...
    public static boolean isLandscape() {
        return XiuDouFangApplication.getContext().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) XiuDouFangApplication.getContext().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static void setSleepDuration(final int duration) {
        Settings.System.putInt(
                XiuDouFangApplication.getContext().getContentResolver(),
    ...
    public static boolean isTablet() {
        return (XiuDouFangApplication.getContext().getResources().getConfiguration().screenLayout
    ...
    public static void cancelAdaptScreen(final Activity activity) {
        final DisplayMetrics appDm = XiuDouFangApplication.getContext().getResources().getDisplayMetrics();

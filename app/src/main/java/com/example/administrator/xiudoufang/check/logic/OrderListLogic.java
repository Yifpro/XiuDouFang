...
public class OrderListLogic {
    ...
    //******** 获取订单列表 ********
    public void requestOrderList(Context context, HashMap<String, String> params, JsonCallback<OrderListBean> callback) {
    ...
    //******** 获取订单明细 ********
    public void requestOrderDetails(Context context, String iid, String c_id, JsonCallback<OrderDetailsBean> callback) {

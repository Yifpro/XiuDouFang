...
public final class SizeUtils {
    ...
    public static int dp2px(final float dpValue) {
        return dp2px(XiuDouFangApplication.getContext(), dpValue);
    }
    ...
    public static int px2dp(final float pxValue) {
        return px2dp(XiuDouFangApplication.getContext(), pxValue);
    }
    ...
    public static int sp2px(final float spValue) {
        return sp2px(XiuDouFangApplication.getContext(), spValue);
    }
    ...
    public static int px2sp(final float pxValue) {
        return px2sp(XiuDouFangApplication.getContext(), pxValue);
    }
    ...
    /**
     * Converts an unpacked complex data value holding white_blue_selected_selector dimension to its final floating
    ...
    public static float applyDimension(final float value, final int unit) {
        return applyDimension(XiuDouFangApplication.getContext(), value, unit);
    }

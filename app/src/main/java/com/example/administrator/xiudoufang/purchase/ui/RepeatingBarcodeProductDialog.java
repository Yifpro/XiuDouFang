...
public class RepeatingBarcodeProductDialog extends DialogFragment implements View.OnClickListener {
    ...
    public static RepeatingBarcodeProductDialog newInstance(int type, ArrayList<SupplierProductListBean.SupplierProductBean> list) {
        RepeatingBarcodeProductDialog dialog = new RepeatingBarcodeProductDialog();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_repeating_barcode_product, container);
    ...
    public RepeatingBarcodeProductDialog setOnItemClickListener(OnItemClickListener listener) {
        mListener = listener;
        return this;
    }
